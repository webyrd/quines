...
Testing "rel-fact5"
Testing "rel-fact5-backwards"
> (run 1 (q) (eval-expo q '() '(intval (0 1 1))))
((intexp (0 1 1)))
> (run 10 (q) (eval-expo q '() '(intval (0 1 1))))
((intexp (0 1 1)) (sub1 (intexp (1 1 1))) (* (intexp (1)) (intexp (0 1 1)))
  (* (intexp (0 1 1)) (intexp (1))) (if #t (intexp (0 1 1)) _.0)
  (* (intexp (0 1)) (intexp (1 1))) (if #f _.0 (intexp (0 1 1)))
  (sub1 (* (intexp (1)) (intexp (1 1 1))))
  (((lambda (_.0) (intexp (0 1 1))) #t)
    (=/= ((_.0 . intexp)))
    (sym _.0))
  (sub1 (* (intexp (1 1 1)) (intexp (1)))))
> (run 30 (q) (eval-expo q '() '(intval (0 1 1))))
((intexp (0 1 1)) (sub1 (intexp (1 1 1)))
 ((lambda () (intexp (0 1 1))))
 (* (intexp (1)) (intexp (0 1 1)))
 (* (intexp (0 1 1)) (intexp (1)))
 (* (intexp (0 1)) (intexp (1 1)))
 (car (list (intexp (0 1 1))))
 (* (intexp (1 1)) (intexp (0 1)))
 ((car (list (intexp (0 1 1)) '_.0))
   (no-closure _.0)
   (no-intval _.0))
 (car (list (intexp (0 1 1)) (list)))
 (((lambda (_.0) (intexp (0 1 1))) '_.1)
   (=/= ((_.0 . intexp)))
   (no-closure _.1)
   (no-intval _.1)
   (sym _.0))
 ((car (list (intexp (0 1 1)) '_.0 '_.1))
   (no-closure _.0 _.1)
   (no-intval _.0 _.1))
 ((lambda () (sub1 (intexp (1 1 1)))))
 (sub1 (sub1 (intexp (0 0 0 1))))
 (car (list (intexp (0 1 1)) #t))
 (((lambda (_.0) (intexp (0 1 1))) (list))
   (=/= ((_.0 . intexp)))
   (sym _.0))
 (if '#t (intexp (0 1 1)) _.0) (if '#f _.0 (intexp (0 1 1)))
 ((car (list (intexp (0 1 1)) '_.0 (list)))
   (no-closure _.0)
   (no-intval _.0))
 (sub1 ((lambda () (intexp (1 1 1)))))
 ((car (list (intexp (0 1 1)) (list) '_.0))
   (no-closure _.0)
   (no-intval _.0))
 (if #t (intexp (0 1 1)) _.0)
 ((car (list (intexp (0 1 1)) '_.0 '_.1 '_.2))
   (no-closure _.0 _.1 _.2)
   (no-intval _.0 _.1 _.2))
 ((car (list (intexp (0 1 1)) '_.0 #t))
   (no-closure _.0)
   (no-intval _.0))
 (sub1 (* (intexp (1)) (intexp (1 1 1))))
 (car (list (intexp (0 1 1)) #f))
 (sub1 (* (intexp (1 1 1)) (intexp (1))))
 (car (list (intexp (0 1 1)) (list) (list)))
 ((car (list (intexp (0 1 1)) '_.0 '_.1 (list)))
   (no-closure _.0 _.1)
   (no-intval _.0 _.1))
 (((lambda (_.0) (intexp (0 1 1))) #t)
   (=/= ((_.0 . intexp)))
...
(((_.0 ((_.0 . _.1) . _.2) _.1) (sym _.0))
  ...
  ((_.0 ((_.1 . _.2) (_.3 . _.4) (_.5 . _.6) (_.7 . _.8) (_.9 . _.10)
    ...
    (=/= ((_.1 . _.0)) ((_.11 . _.0)) ((_.13 . _.0))
         ...
         ((_.9 . _.0)))
    (sym _.0)))
> (run 10 (q) (fresh (exp type) (!- exp '() type) (== `(,exp ,type) q)))
((((lambda (_.0) _.0) (-> _.1 _.1)) (sym _.0))
